...
export default class Item5e extends Item {
  ...
  async use(config={}, options={}) {
    ...
    config = foundry.utils.mergeObject({
      ...
      consumeSpellPoints: requireSpellSlot ? is.points : false
    }, config);
    ...
    if ( isSpell && (config.consumeSpellSlot || config.consumeSpellLevel || config.consumeSpellPoints) ) {
  ...
  _getUsageUpdates({
    ...
    consumeSpellLevel, consumeUsage, consumeSpellPoints}) {
    const actorUpdates = {};
    const itemUpdates = {};
